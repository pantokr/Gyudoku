...
public class HelpDialogManager : MonoBehaviour
{
    ...
    public void StartDialog()
    {
        ...
        string[] _texts = { "스도쿠를 더 쉽게 풀 수 있도록 해주는 도구들이 있습니다.",
            "1. 메모 : 'Tab'을 누르면 메모 모드를 켜고 끌 수 있으며(화면 색이 변합니다), 셀에서 'Alt + 키보드의 숫자'를 누르면 빠르게 메모할 수 있습니다.)",
            ...
            "4. 초기화 : 스도쿠를 초기화합니다.",
            "5. 숫자 강조 : 이 버튼 중 하나를 누르면 해당하는 숫자를 강조합니다. 'Ctrl + 키보드의 숫자'를 누르면 숫자 강조 버튼을 누르지 않고 바로 숫자를 강조할 수 있습니다.",
            "6. 자동 메모 : 모든 셀에 메모를 자동으로 채워줍니다.",
            "7. !힌트! : 스도쿠를 한 단계씩 자동으로 풀어줍니다.",
            "8. 자동 싱글 : 스도쿠 풀이에서 가장 기본적인 '나머지 한 칸 채우기'를 자동으로 해결합니다.",
            "9. 스도쿠 저장 : 파일명을 지정해 저장하면, 메인 메뉴의 커스텀 모드에서 다시 플레이 할 수 있습니다."};
